...
class RouteAnalyzer:
    ...
    def load_and_prepare_data(self):
        ...
        self.play_data['success'] = (self.play_data['expected_points_added'] > 0).astype(int)
        return self.play_data
    
    def train_physics_model(self):
        features = ['launch_velocity', 'launch_angle_deg', 'v_xy', 'pass_length']
        X = self.play_data[features].fillna(self.play_data[features].median())
        y = self.play_data['success']
    ...
    def create_individual_route_images(self, output_dir: Path):
        ...
        route_counts = self.play_data['route_of_targeted_receiver'].value_counts()
    ...
    def _create_single_route_image(self, route: str, output_dir: Path):
        ...
        route_plays = self.play_data[self.play_data['route_of_targeted_receiver'] == route]
