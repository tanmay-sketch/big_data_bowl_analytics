...
def load_data(dir_path: Path) -> pd.DataFrame:
    ...
    supplementary_cols_to_drop = ['week','game_date','game_time_eastern','penalty_yards','season','play_description','play_nullified_by_penalty','pass_result','receiver_alignment','pre_penalty_yards_gained','yards_gained']
    ...
    supplementary_df["play_action"] = supplementary_df["play_action"].map({"TRUE": True, "FALSE": False})
